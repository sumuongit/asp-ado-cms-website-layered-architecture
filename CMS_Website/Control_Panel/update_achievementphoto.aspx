<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPage.master" AutoEventWireup="true" CodeBehind="update_achievementphoto.aspx.cs" Inherits="CMS_Website.Control_Panel.update_achievementphoto" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container top_break_control_panel">
          <div class="container">
            <div class="row">
                 <div class="col-sm-6">
                     <h4 style="color:green">Achievement Photo Update Form</h4><br />
                     <asp:image ID="AchievementPhoto" runat="server" Height="250px" Width="250px"></asp:image> 
